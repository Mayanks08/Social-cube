...
import { BellIcon, Box, HomeIcon, UserIcon} from 'lucide-react';
...
const Sidebar = () => {
  ...
  return (
    <aside className="w-68 bg-base-300 border-r border-base-200 hidden lg:flex flex-col h-screen sticky top-1">
